...
(function (w, d, u) {
  ...
  if (getQSParameterByName("lang", w.location.href))
    ...
    parseURL(w.location.href, false).substring(0, 4).replace(/\//g, "")
      .length == 2
  )
